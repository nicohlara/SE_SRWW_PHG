...
#plink2 --bfile assemblies_plink2 --indep-pairwise 10000kb 0.8 --allow-extra-chr --bad-ld --out test2

LDBlockShow -InVCF assemblies_norm_filter2.vcf.gz -OutPut ldblock_test \
	-SeleVar 3 \
	-BlockType 1 \
	-Region chr5B:1-714533050
